...
function App() {
  ...
  // Filter products by category — useMemo so it only recalculates when needed
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto', padding: '2rem 1rem' }}>
      ...
      {/* Category filter + product grid — shown when no product selected */}
      {!selectedProduct && (
        <>
          <CategoryFilter
      ...
      {product && !loading && (
        <div>
          ...
          <button
            ...
            style={{ background:'none', border:'none', color:'#64748b', cursor:'pointer', fontSize:'14px', marginBottom:'1rem', padding:0 }}
          >
            ← Back to products
          </button>
          ...
          <div style={{ display:'flex', alignItems:'flex-start', justifyContent:'space-between', marginBottom:'1rem' }}>
            ...
            <WatchlistButton productId={product.product.id} onAuthRequired={() => setShowAuthModal(true)} />
          </div>
